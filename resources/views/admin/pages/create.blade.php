...
@section('content')
    <div class="row mb-5">
        <div class="col-md-8">
            <h2 class="welcome-title mb-1">{{ __('New Page') }}</h2>
            <p class="text-muted mb-0">{{ __('Create a new page and assign the correct template.') }}</p>
        </div>
                    ...
                    <div class="panel-body pt-0">
                                ...
                                <div class="tab-pane fade {{ $locale['code'] === $firstSelectedLocaleCode ? 'show active' : '' }} {{ $isSelected ? '' : 'd-none' }}"
                                    ...
                                    <div class="mb-4">
                                        @include('admin.partials.ai-locale-toolbar', [
                                            ...
                                            'translateUrl' => route('admin.pages.ai.translate-draft'),
                                            'seoUrl' => route('admin.pages.ai.seo-draft'),
                                            'draftMode' => true,
                                        ])
                                        <label class="form-label small fw-bold text-muted uppercase letter-spacing-1">
                                            {{ __('Page Blocks') }}
                                                            ...
                                                            @foreach($editor['fields'] as $field)
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    @elseif($fieldType === 'image')
                                                                        @if($fieldValue !== '')
                                                                            <div class="mb-2">
                                                                                <a href="{{ asset('storage/'.$fieldValue) }}" target="_blank" class="small text-decoration-none">{{ __('Current image') }}</a>
                                                                            </div>
                                                                        @endif
                                                                        <input type="text"
                                                                    ...
                                                                    @elseif($fieldType === 'video')
                                                                        @if($fieldValue !== '')
                                                                            <div class="mb-2">
                                                                                <a href="{{ asset('storage/'.$fieldValue) }}" target="_blank" class="small text-decoration-none">{{ __('Current video') }}</a>
                                                                            </div>
                                                                        @endif
                                                                        <input type="text"
                                                                               name="blocks[{{ $locale['code'] }}][{{ $block['key'] }}][data][{{ $fieldKey }}]"
                                        ...
                                        @foreach($locales as $locale)
                                            ...
                                            <div class="tab-pane fade {{ $locale['code'] === $firstSelectedLocaleCode ? 'show active' : '' }} {{ $isSelected ? '' : 'd-none' }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="meta_titles[{{ $locale['code'] }}]" class="form-control form-control-sm shadow-none" value="{{ old('meta_titles.'.$locale['code']) }}" {{ $isSelected ? '' : 'disabled' }}>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label small fw-bold text-muted uppercase letter-spacing-1">{{ __('Meta Description') }}</label>
                                                    <textarea name="meta_descriptions[{{ $locale['code'] }}]" class="form-control form-control-sm shadow-none" rows="3" {{ $isSelected ? '' : 'disabled' }}>{{ old('meta_descriptions.'.$locale['code']) }}</textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="keywords-tag-input" data-keywords-widget>
                                                        ...
                                                        <input type="hidden"
                                                               ...
                                                               value="{{ old('meta_keywords.'.$locale['code']) }}"
                                                               {{ $isSelected ? '' : 'disabled' }}>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="focus_keywords[{{ $locale['code'] }}]" class="form-control form-control-sm shadow-none" value="{{ old('focus_keywords.'.$locale['code']) }}" {{ $isSelected ? '' : 'disabled' }}>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label small fw-bold text-muted uppercase letter-spacing-1">{{ __('Canonical URL') }}</label>
                                                    <input type="url" name="canonical_urls[{{ $locale['code'] }}]" class="form-control form-control-sm shadow-none" value="{{ old('canonical_urls.'.$locale['code']) }}" {{ $isSelected ? '' : 'disabled' }}>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary px-5 py-3 rounded-3 shadow-premium d-flex align-items-center gap-2">
                                ...
                                <span class="fw-bold">{{ __('Save Page') }}</span>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dashboard-panel premium-shadow mb-4 settings-panel">
                        ...
                        <div class="panel-body">
                            <div class="mb-3">
                                ...
                                <select name="template" class="form-select @error('template') is-invalid @enderror" required>
                                    ...
                                    @foreach($templates as $template)
                                        <option value="{{ $template['slug'] }}" @selected(old('template') === $template['slug'])>
                                            {{ $template['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="parent_id" class="form-select @error('parent_id') is-invalid @enderror">
                                    ...
                                    @foreach($parentPages as $parentPage)
                                        <option value="{{ $parentPage['id'] }}" @selected((int) old('parent_id') === $parentPage['id'])>
                                            {{ $parentPage['title'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3" data-media-field-wrapper>
                                ...
                                <input type="text" name="feature_image" class="form-control @error('feature_image') is-invalid @enderror mb-2" value="{{ old('feature_image') }}">
                            ...
                            <div class="form-check form-switch p-0 ps-5 mt-4">
                                <input class="form-check-input ms-n5" type="checkbox" id="published" name="published" value="1" @checked(old('published', true))>
                                <label class="form-check-label fw-bold" for="published">{{ __('Published') }}</label>
                            </div>

                            <div class="form-check form-switch p-0 ps-5 mt-3">
                                <input class="form-check-input ms-n5" type="checkbox" id="is_home" name="is_home" value="1" @checked(old('is_home', false))>
...
@include('admin.partials.block-instance-script')
    ...
    document.addEventListener('click', function(event) {
        ...
        if (removeImageButton) {
            ...
            const previewWrap = fieldWrapper.querySelector('.image-preview-wrap') || removeImageButton.closest('.mb-2');
        ...
        if (removeGalleryItemButton) {
            ...
            const galleryItem = removeGalleryItemButton.closest('.gallery-item') || removeGalleryItemButton.closest('.position-relative');
            if (galleryItem) {
                galleryItem.remove();
            }
