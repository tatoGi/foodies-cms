...
@section('content')
    <div class="row mb-5">
        <div class="col-md-8">
            <h2 class="welcome-title mb-1">{{ __('New Post') }}</h2>
            <p class="text-muted mb-0">{{ __('Create a new post with blocks and SEO.') }}</p>
        </div>
    ...
    <form action="{{ route('admin.posts.store') }}" method="POST" id="pageForm" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="panel-body pt-0">
                                ...
                                <div class="tab-pane fade {{ $locale['code'] === $firstSelectedLocaleCode ? 'show active' : '' }} {{ $isSelected ? '' : 'd-none' }}"
                                    ...
                                    <div class="mb-4">
                                        @include('admin.partials.ai-locale-toolbar', [
                                            ...
                                            'translateUrl' => route('admin.posts.ai.translate-draft'),
                                            'seoUrl' => route('admin.posts.ai.seo-draft'),
                                            'draftMode' => true,
                                        ])
                                        <label class="form-label small fw-bold text-muted uppercase letter-spacing-1">
                                            {{ __('Post Blocks') }}
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="keywords-tag-input" data-keywords-widget>
                                                        ...
                                                        <input type="hidden"
                                                               ...
                                                               value="{{ old('keywords.'.$locale['code']) }}"
                                                               {{ $isSelected ? '' : 'disabled' }}>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary px-5 py-3 rounded-3 shadow-premium d-flex align-items-center gap-2">
                                ...
                                <span class="fw-bold">{{ __('Save Post') }}</span>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dashboard-panel premium-shadow mb-4 settings-panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="feature_image" class="form-control @error('feature_image') is-invalid @enderror" value="{{ old('feature_image') }}">
                                @error('feature_image')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
