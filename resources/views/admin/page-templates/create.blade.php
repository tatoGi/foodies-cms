...
@section('title', __('Create Page Template'))
@section('page_title', __('Create Template'))
...
@section('content')
    <div class="row mb-5">
        <div class="col-md-8">
            <h2 class="welcome-title mb-1">{{ __('New Page Template') }}</h2>
            <p class="text-muted mb-0">{{ __('Define a new structure for your website pages.') }}</p>
        </div>
    ...
    <form action="{{ route('admin.page-templates.store') }}" method="POST">
        @csrf
                    ...
                    <div class="panel-body pt-0">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary px-5 py-3 rounded-3 shadow-premium d-flex align-items-center gap-2">
                                ...
                                <span class="fw-bold">{{ __('Save Template') }}</span>
                            </button>
                        </div>
                    </div>
                </div>
